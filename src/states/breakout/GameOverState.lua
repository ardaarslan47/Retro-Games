...
BreakoutGameOverState = Class{__includes = BaseState}

function BreakoutGameOverState:enter(params)
    self.highScores = params.highScores
    self.score = params.score
end

function BreakoutGameOverState:update(dt)
...
function BreakoutGameOverState:render()
